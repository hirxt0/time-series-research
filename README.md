...
# 4) Интерфейс
## Для удобства использования моделей был создан веб-сервис, позволяющий загрузить свои данные магнитного поля для последующей детекции аномалий, а так же заполнения пропусков с помощью моделей
